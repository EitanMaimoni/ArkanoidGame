     ...
     * */
        public void checkBall(){
           ...
           //these balls are out of range of screen
            ...
            assert (b2.getVelocity().getVelocityX() == v1.getVelocityX() && b2.getVelocity().getVelocityY() == v1.getVelocityY());
            b2.setVelocity(5.4,8.9);
            assert(b2.getVelocity().getVelocityX() == v2.getVelocityX() && b2.getVelocity().getVelocityY() == v2.getVelocityY());
            b9.setVelocity(v4);
            assert(b9.getVelocity().getVelocityX() == v4.getVelocityX() && b9.getVelocity().getVelocityY() == v4.getVelocityY());
            b10.setVelocity(v2);
            assert (b10.getVelocity().getVelocityX() == v2.getVelocityX() && b10.getVelocity().getVelocityY() == v2.getVelocityY());
            b11.setVelocity(v3);
            assert (b11.getVelocity().getVelocityX() == v3.getVelocityX() && b11.getVelocity().getVelocityY() == v3.getVelocityY());
            b12.setVelocity(v5);
            assert (b12.getVelocity().getVelocityX() == v5.getVelocityX() && b12.getVelocity().getVelocityY() == v5.getVelocityY());
            ...
            for (Ball b : balls) {
                for (Ball c: balls){
                   // make sure balls increase in speed as they decrease in size
                    assert (((Math.sqrt(Math.pow(b.getX()-b.getVelocity().getVelocityX(), 2))
                            + Math.pow(b.getY()-b.getVelocity().getVelocityY(), 2) / SLEEP
                            > Math.sqrt(Math.pow(c.getX()-c.getVelocity().getVelocityX(), 2))
                            + Math.pow(c.getY()-c.getVelocity().getVelocityY(), 2) / SLEEP) && b.getSize()>c.getSize())
                            || ((Math.sqrt(Math.pow(b.getX()-b.getVelocity().getVelocityX(), 2))
                            + Math.pow(b.getY()-b.getVelocity().getVelocityY(), 2) / SLEEP
                            < Math.sqrt(Math.pow(c.getX()-c.getVelocity().getVelocityX(), 2))
                            + Math.pow(c.getY()-c.getVelocity().getVelocityY(), 2) / SLEEP) && b.getSize()< c.getSize())
                            || ((Math.sqrt(Math.pow(b.getX()-b.getVelocity().getVelocityX(), 2))
